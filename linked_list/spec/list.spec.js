...
describe('Returning all indexes in a list that contain the correct value', () => {
  ...
  test('adding several items to the head, tail, before, after and removing', () => {
    list.addToFront(36)
    list.addToFront(27)
    list.addToBack(36)
    list.addToFront(39)
    list.insertAfter(27, 39)
    list.addToBack(101)
    list.insertBefore(101, 36)
    expect(list.indexOf(39)).toEqual([0, 2])
    list.removeItem(39)
    expect(list.indexOf(39)).toEqual([1])
    list.removeItem(39)
    expect(list.indexOf(39)).toEqual([])
    expect(list.indexOf(101)).toEqual([4])
  })
})